...
using static SharpServiceCollection.Generators.Constants.InjectableDependencyConstants.AttributeMetadata;
...
using static SharpServiceCollection.Generators.Constants.ServiceRegistrationConstants;


namespace SharpServiceCollection.Generators;

[Generator]
public sealed class ServiceRegistrationGeneratorOld : IIncrementalGenerator
{
        ...
        bool isServiceRegistrationRoot)
    {
        ...
        context.AddSource(ServiceRegistrationConstants.GeneratedFileName,
    ...
    private static bool HasExecuteAsync(INamedTypeSymbol typeSymbol, bool isGeneric)
    {
        ...
        foreach (var member in typeSymbol.GetMembers(ServiceRegistrationConstants.ExecuteMethodName))
        {
