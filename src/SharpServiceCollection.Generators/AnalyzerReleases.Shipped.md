...
---------|----------------------------------------|----------|-----------------------------------------------------------------------
 ...
 SSC005  | SharpServiceCollection.Generators | Error    | ServiceRegistrationBase subclass must be sealed                       
 SSC006  | SharpServiceCollection.Generators | Error    | ServiceRegistration requires an accessible parameterless constructor   
